				...
				<div class="panel-body">
					<?php echo form_open_multipart($action, 'id="form-city" class="form"'); ?>
						...
						<div class="form-group">
							...
							<div class="">
								<?php echo form_dropdown('country_id', option_array_value($countries, 'country_id', 'name'), set_value('country_id', $country_id),"id='country_id' class='form-control select2'"); ?>
							</div>
						</div>
						<div class="form-group required">
...
$(document).ready(function() {
		$('select[name=\'country_id\']').bind('change', function() {
			$.ajax({
				url: '<?php echo base_url("localisation/country/country"); ?>/' + this.value,
				dataType: 'json',
				beforeSend: function() {
