...
<?php foreach ($errors as $error): ?>
   <div class="alert alert-danger alert-dismissible"><i class="fa fa-exclamation-circle"></i> <?php echo $error; ?>
...
<div class="box">
    <table width="100%" class="table">
        ...
        <tbody>
            <tr>
                <td>MySQLi:</td>
                <td class="align_center"><?php echo extension_loaded('mysqli') ? 'On' : 'Off'; ?></td>
                <td class="align_center">On</td>
                <td class="align_center"><img src="<?php echo base_url() . 'assets/images/' . ((extension_loaded('mysqli')) ? 'good' : 'bad'); ?>.png" /></td>
            </tr>
            <tr>
                <td>GD:</td>
...
<div class="box">
    <table width="100%" class="table">
        ...
        <tbody>
            <tr>
                <td><?php echo CMS_ROOT . 'app.php'; ?></td>
                <td class="align_center"><?php echo is_writable(CMS_ROOT . 'app.php') ? '<span class="good">Writable</span>' : '<span class="bad">Unwritable</span>'; ?></td>
            </tr>
        </tbody>
    </table>
</div>
